...
main = string(datetime('now','Format','M-d-y@HH.mm.ss'))+"code3RbDe1KE1uK";
mkdir(main);
...
fprintf("\n\nr0 = %.20e;\n",r0);
fprintf("sigmaxion = %.20e;\n",sqrt(kB*Tion/Eh/(mion*w^2)));
fprintf("sigmavxion = %.20e;\n",sqrt(kB*Tion/Eh/mion));
fprintf("sigmavxatom = %.20e;\n",sqrt(kB*Tatom/Eh/matom));
fprintf("tfinal = %.20e;\n",tmax);
fprintf("rtol = %.20e;\n",rtol);
fprintf("atol = %.20e;\n",atol);
fprintf("C4 = %.20e;\n",C4);
...
sigmaxion = 3.42672917729586686164e+02;
sigmavxion = 1.00812383135607866568e-08;
sigmavxatom = 4.47093372999080656691e-09;
...
rbounce = 7.08448174250339519631e+01;
    ...
    y02 = randn*sigmaxion;
    y03 = randn*sigmaxion;
    y04 = randn*sigmavxion;
    y05 = randn*sigmavxion;
    y06 = randn*sigmavxion;
    y07 = r0*sin(theta0)*cos(phi0);
    y08 = r0*sin(theta0)*sin(phi0);
    y09 = r0*cos(theta0);
    y010 = randn*sigmavxatom;
    y011 = randn*sigmavxatom;
    y012 = randn*sigmavxatom;
    if y07*y010+y08*y011+y09*y012 > 0
        y010 = -y010;
        y011 = -y011;
        y012 = -y012;
    end
    ...
    f04 = f04 - (ax+2*qx)*OmegaRF^2/4*y01;
    f05 = f05 - (ax+2*-qx)*OmegaRF^2/4*y02;
    f06 = f06 - (az)*OmegaRF^2/4*y03; %odeend
    threshold = atol / rtol;
