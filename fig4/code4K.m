...
main = string(datetime('now','Format','M-d-y@HH.mm.ss'))+"code4K";
mkdir(main);
...
C4 = 1.46438899999999989632e+02;
C8 = 1.69289765143178796768e+09;
mion = 3.11597855084210925270e+05;
matom = 7.10264919369594572345e+04;
...
rbounce = 6.93427498573702365547e+01;
